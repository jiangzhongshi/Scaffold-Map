...
//template void retain_tetrahedral_adjacency<std::set<int,
//                                                       std::less<int>,
//                                                 std::allocator<int> >, std::vector<int, std::allocator<int> > >(std::set<int, std::less<int>, std::allocator<int> > const&, std::vector<int, std::allocator<int> > const&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > > const&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 4, 3, 0, 4, 3>, std::allocator<Eigen::Matrix<int, 4, 3, 0, 4, 3> > >&);
//template void retain_tetrahedral_adjacency<std::vector<int,
//                                                   std::allocator<int> >, std::vector<int, std::allocator<int> > >(std::vector<int, std::allocator<int> > const&, std::vector<int, std::allocator<int> > const&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > > const&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 1, 4, 1, 1, 4>, std::allocator<Eigen::Matrix<int, 1, 4, 1, 1, 4> > >&, std::vector<Eigen::Matrix<int, 4, 3, 0, 4, 3>, std::allocator<Eigen::Matrix<int, 4, 3, 0, 4, 3> > >&);
//
#endif
